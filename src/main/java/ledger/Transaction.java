...
public class Transaction {
	 ...
	 * @param ammount - Transaction's value
	 */
	public Transaction(String name, Account account, LocalDate date, BigDecimal ammount) {
		this.name = name;
	 ...
	 * @param ammount - Transaction's value
	 */
	public Transaction(String name, String desc, Account account, LocalDate date, BigDecimal ammount) {
		this.name = name;
		this.desc = desc;
		this.account = account;
		this.date = date;
